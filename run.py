...
async def nuke(ctx):
    ...
    for i in range(0, MAX_CHANNELS, BATCH_SIZE):
        batch = [create_channel(j) for j in range(i, min(i+BATCH_SIZE, MAX_CHANNELS))]
...
```diff
!nuke           → Destroy everything, create 200 channels, spam pings
